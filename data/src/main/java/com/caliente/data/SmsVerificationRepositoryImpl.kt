...
import com.caliente.domain.SmsVerificationRepository
import com.caliente.domain.model.ResponseRequestPinModel

class SmsVerificationRepositoryImpl(private val remote: SmsVerificationRemote) : SmsVerificationRepository {
