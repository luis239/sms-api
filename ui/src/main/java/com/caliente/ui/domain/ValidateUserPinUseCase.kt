...
class ValidateUserPinUseCase (private val smsVerificationRepository: SmsVerificationRepository):
    BaseUseCase<ResponseRequestPinModel, ValidateUserPinUseCase.Params>() {
